...
_lr_productions = [
  ...
  ('statement -> var_dec','statement',1,'p_statement','parser.py',18),
  ('statement -> function_dec','statement',1,'p_statement','parser.py',19),
  ('statement -> comment','statement',1,'p_statement','parser.py',20),
  ('package_dec -> PACKAGE NAME SEMI body','package_dec',4,'p_package_dec','parser.py',24),
  ('function_dec -> SUB NAME braces_left body braces_right','function_dec',5,'p_function_dec','parser.py',29),
  ('var_dec -> MY NAME EQUAL SHIFT SEMI','var_dec',5,'p_var_dec','parser.py',34),
  ('comment -> COMMENT','comment',1,'p_comment','parser.py',40),
  ('braces_left -> BRACES_LEFT','braces_left',1,'p_braces_left','parser.py',44),
  ('braces_right -> BRACES_RIGHT','braces_right',1,'p_braces_right','parser.py',49),
